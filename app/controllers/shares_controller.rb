class SharesController < ApplicationController
  ...
  def share_params
    params.require(:share).permit(:name, :size, :group_id, :email, :telephone, :moneymaker, :super_moneymaker, :offer_minimum, :offer_medium, :offer_maximum, :password, :password_confirmation, :feedback, :land_help_days, :no_help, :skills, :agreed, workgroup_ids: [])
  end
